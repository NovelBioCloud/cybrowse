...
class ViewModel {
  ...
  validate() {
    return this._source && this._target && this._relation && this._file
  }
}
class View {
  constructor() {
      ...
      buttons: [{
        ...
        action: (dialog) => {
          if (this.viewModel.validate()) {
            ...
            this.context.services.messageService.error('数据填写不完整!')
          }
        }
      }, {
        label: '&nbsp;取消',
    ...
    return `<div class=''>
      <form class='form-horizontal' role='form'>
        <div class='form-group'>
          ...
          <div class='col-sm-7'>
            <input type='text' class='fn-source form-control' id='source' placehoder='source'/>
          </div>
        </div>
        <div class='form-group'>
          <label class='control-label col-sm-3' for='target'>target</label>
          <div class='col-sm-7'>
            <input type='text' class='fn-target form-control' id='target' placehoder='target'/>
          </div>
        </div>
        <div class='form-group'>
          <label class='control-label col-sm-3' for='relation'>relation</label>
          <div class='col-sm-7'>
            <input type='text' class='fn-relation form-control' id='relation' placehoder='relation'/>
          </div>
        </div>
        <div class='form-group'>
